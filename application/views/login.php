				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Metode AHP Penilaian Kinerja Guru Terbaik di SMK Islam Jipang</h4>
                            <p class="pt-4">
                                UNIVERSITAS PERADABAN|TEKNIK INFORMATIKA
                            </p>
                            <p>
                                PUTRI SUNIA SARI
                            </p>
